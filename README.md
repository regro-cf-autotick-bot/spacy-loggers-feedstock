...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spacy-loggers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14207&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spacy-loggers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spacy-loggers` can be installed with:

```
conda install spacy-loggers
```

It is possible to list all of the versions of `spacy-loggers` available on your platform with:
